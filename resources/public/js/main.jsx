...
var blogPosts = [{title: "Learning React", body: "My site has been a useful place for practice, rewriting it whenever I want to t\
ry something new. I originally wrote my site in ClojureScript, and when I wanted to practice JavaScript I rewrote it. This last t\
ime I used React, which is simple-ish enough to set up and allows you to work it into your project at your own speed, meaning you\
r entire code base doesn’t have to be changed at once to get something to render. (side note: I know I could be creating knew thi\
ngs instead of rewriting the same project every time, but I find it’s a good starting point for to get an initial grasp.) Compone\
nts allow for an organized structure. You don’t have to write the same code in three different places, meaning a smaller more rea\
dable codebase, and who wouldn’t want that. React’s reusable components have been most useful for the blog portion of my site. So\
...
by this. Why couldn’t I meet people who do something else, I’m sure they’d be so much interesting. Now that is a ridiculous notio\
n to me, this community has so much creativity swirling around, and I just wasn’t asking the right questions. I enjoy hearing abo\
ut people’s personal projects, what they spend their free time creating is a fun window into how they think and what their intere\
sts are. It refreshing to come across all of this originality and creativity daily, programmers don’t get enough respect for thei\
r artistic side."},
